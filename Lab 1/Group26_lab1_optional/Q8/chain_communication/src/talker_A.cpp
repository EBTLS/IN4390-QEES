...
int main(int argc, char *argv[]) {
    ...
    auto node = rclcpp::Node::make_shared("talker_A");
    ...
    auto chatter_pub = node->create_publisher<std_msgs::msg::String>("A2B", custom_qos_profile);
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_256byte.txt", "./evaluation/publish_time_A/publish_time_256byte.txt",
                  chatter_pub);
        if (count == -1) {
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_512byte.txt", "./evaluation/publish_time_A/publish_time_512byte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_1Kbyte.txt", "./evaluation/publish_time_A/publish_time_1Kbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_2Kbyte.txt", "./evaluation/publish_time_A/publish_time_2Kbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_4Kbyte.txt", "./evaluation/publish_time_A/publish_time_4Kbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_8Kbyte.txt", "./evaluation/publish_time_A/publish_time_8Kbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_16Kbyte.txt", "./evaluation/publish_time_A/publish_time_16Kbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_32Kbyte.txt", "./evaluation/publish_time_A/publish_time_32Kbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_64Kbyte.txt", "./evaluation/publish_time_A/publish_time_64Kbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_128Kbyte.txt", "./evaluation/publish_time_A/publish_time_128Kbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_256Kbyte.txt", "./evaluation/publish_time_A/publish_time_256Kbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_512Kbyte.txt", "./evaluation/publish_time_A/publish_time_512Kbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_1Mbyte.txt", "./evaluation/publish_time_A/publish_time_1Mbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_2Mbyte.txt", "./evaluation/publish_time_A/publish_time_2Mbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
    ...
    while (rclcpp::ok()) {
        eval_ros2("./evaluation/byte_data/data_4Mbyte.txt", "./evaluation/publish_time_A/publish_time_4Mbyte.txt",
                  chatter_pub);
        if (count == -1) {
            printf("end this data size evaluation \n");
            break;
