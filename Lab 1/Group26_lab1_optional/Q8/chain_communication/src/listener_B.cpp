...
private:
    ...
    std::string output_filename = "./evaluation/subscribe_time_B/subscribe_time_256byte.txt";
...
listener_pingpong::listener_pingpong() : Node("listener_B") {
...
//    this->listener_qos_profile=qos_profile;
    ...
    listener_publisher = this->create_publisher<std_msgs::msg::String>("B2C", this->listener_qos_profile);
    listener_subscription = this->create_subscription<std_msgs::msg::String>("A2B",
                                                                             std::bind(
...
//        ss.clear();
        ...
        if (eval_loop_count == 1) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_512byte.txt";
        } else if (eval_loop_count == 2) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_1Kbyte.txt";
        } else if (eval_loop_count == 3) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_2Kbyte.txt";
        } else if (eval_loop_count == 4) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_4Kbyte.txt";
        } else if (eval_loop_count == 5) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_8Kbyte.txt";
        } else if (eval_loop_count == 6) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_16Kbyte.txt";
        } else if (eval_loop_count == 7) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_32Kbyte.txt";
        } else if (eval_loop_count == 8) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_64Kbyte.txt";
        } else if (eval_loop_count == 9) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_128Kbyte.txt";
        } else if (eval_loop_count == 10) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_256Kbyte.txt";
        } else if (eval_loop_count == 11) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_512Kbyte.txt";
        } else if (eval_loop_count == 12) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_1Mbyte.txt";
        } else if (eval_loop_count == 13) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_2Mbyte.txt";
        } else if (eval_loop_count == 14) {
            output_filename = "./evaluation/subscribe_time_B/subscribe_time_4Mbyte.txt";
